...
- Phase 3.5: Vercel 배포 + **Phase 3.6 Vercel API 200** + Register 후 **실차량 데이터** 연동
...
- 진행 현황(2026-07-07): Partner Register 후 Tesla sync 성공, `usedFallback=false`, `provider=tesla` 확인. 다만 차량 상태에 따라 `vehicle_data`의 배터리/위치 필드는 제한적으로 올 수 있다.
