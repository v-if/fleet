...
[ ] (인지) Phase 4.5 — FMS status allowlist는 active Telemetry 구독 VIN만 (단절 차량 제외)
...
| [checklist-tesla-fleet-telemetry-disconnect.md](./checklist-tesla-fleet-telemetry-disconnect.md) | Phase 4.5 연동 해제 (A~C 완료) |
...
| 2026-07-11 | Phase 4.5 — allowlist=active 구독만 (단절 VIN 제외) 인지 항목 추가 |
