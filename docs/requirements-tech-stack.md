...
[Frontend]  Next.js 15 + React 19 + TypeScript
     ...
     │      Map: Naver Maps JS API v3 (NCP) / Mapbox (대안)
     ▼
...
| 지도 | **Naver Maps API v3** | — | NCP Web Dynamic Map (국내 데모) |
...
| `NEXT_PUBLIC_NAVER_MAP_CLIENT_ID` | Naver Maps (Web Dynamic Map) Client ID |
...
| Phase | 기간 목표 | 기술 추가 |
|-------|-----------|-----------|
| **MVP** | 데모데이 | Next.js, Supabase, Prisma, Mock+OEM 1종, Naver Maps, Vercel Cron |
...
| 2026-07-08 | API 로그·감사 요구사항 연계 — `AuditLog`·`ApiCallLog`, 인터셉터 + 명시적 AuditLog 전략 [requirements-log-db.md](./requirements-log-db.md) |
| 2026-07-08 | Phase 4 P0 로그 구현 — Tesla/FMS 변경 API 감사 로그, 마스킹 유틸, Prisma 로그 스키마 반영 |
