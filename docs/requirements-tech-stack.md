...
**전환 일정**: Phase 1~3는 로컬 SQLite로 개발했다. **Phase 3.6**에서 PostgreSQL로 전환 완료(로컬, 2026-07-07). Vercel 프로덕션 env·재배포는 진행 중. 상세: [requirements-db.md](./requirements-db.md).
