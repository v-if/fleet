...
| REST 제원 블록 | **이미 있음 · TRF-B1** | 접힘 유지, Hero에 넣지 않음 |
...
이미 있는 것: Summary·지도·인근충전소·충전 서브카드(CC)·3×2 퀵타일·TPMS·문상세·OTA/목적지 일부(CAF-4)·제원 접힘·운영 타임라인(VD-OPS).
...
결정 체크리스트(초안): 모드 뱃지 · SoC · 지도 · nearby · 충전 중 Dynamic · 주행 중 목적지 · 제원 접힘 · 운영 CTA.
