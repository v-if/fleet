...
### Phase VD3-DCn 주행 중 안내 종료 클리어 — ✅ 코드 · ☐ 실차

> [requirements-vehicle-detail-nav-cancel-clear.md](./requirements-vehicle-detail-nav-cancel-clear.md)

- [x] **VD3-DCn-0** 문서 승인 (GO)
- [x] **VD3-DCn-1** Mapper Invalid·presence (`tripNavCleared`)
- [x] **VD3-DCn-2** CAF merge cleared (Nav만 · 속도 유지)
- [x] **VD3-DCn-3** verify (`npm run vd3-dcn:verify`)
- [ ] **VD3-DCn-4** 실차 검수
