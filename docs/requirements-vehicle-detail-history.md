...
| 종료 | → **`COMPLETE`**(충전 완료) **또는** `DISCONNECTED`(케이블 해제). `STOPPED`는 세션 유지·갱신 — [VD3-Hc](./requirements-vehicle-detail-history-charge-complete.md) |
...
| 2026-07-19 | CHARGE 종료 갭 — [VD3-Hc](./requirements-vehicle-detail-history-charge-complete.md) (COMPLETE→close · GO) |
| 2026-07-19 | VD3-Hc 코드 ✅ — COMPLETE→close · verify · §3.2 개정 |
