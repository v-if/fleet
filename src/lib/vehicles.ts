...
function serializeSnapshot(snapshot: VehicleSnapshot) {
  ...
  return {
    ...
    chargingPowerKind: snapshot.chargingPowerKind ?? null,
    ...
    vehicleSpeedKmh: snapshot.vehicleSpeedKmh ?? null,
    gpsHeading: snapshot.gpsHeading ?? null,
    detailedChargeState: snapshot.detailedChargeState ?? null,
    timeToFullChargeHours: snapshot.timeToFullChargeHours ?? null,
    chargeAmps: snapshot.chargeAmps ?? null,
    chargePortDoorOpen: snapshot.chargePortDoorOpen ?? null,
    chargePortLatch: snapshot.chargePortLatch ?? null,
    fastChargerPresent: snapshot.fastChargerPresent ?? null,
    tpmsHardWarnings: snapshot.tpmsHardWarnings ?? null,
    tpmsSoftWarnings: snapshot.tpmsSoftWarnings ?? null,
    destinationName: snapshot.destinationName ?? null,
    destinationLatitude: snapshot.destinationLatitude ?? null,
    destinationLongitude: snapshot.destinationLongitude ?? null,
    minutesToArrival: snapshot.minutesToArrival ?? null,
    milesToArrival: snapshot.milesToArrival ?? null,
    expectedEnergyPercentAtArrival: snapshot.expectedEnergyPercentAtArrival ?? null,
    preconditioningEnabled: snapshot.preconditioningEnabled ?? null,
    valetModeEnabled: snapshot.valetModeEnabled ?? null,
    serviceModeEnabled: snapshot.serviceModeEnabled ?? null,
    softwareUpdateDownloadPercent: snapshot.softwareUpdateDownloadPercent ?? null,
    softwareUpdateInstallPercent: snapshot.softwareUpdateInstallPercent ?? null,
